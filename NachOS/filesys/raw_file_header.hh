...
static const unsigned NUM_DIRECT
  = (SECTOR_SIZE - 4 * sizeof (int) - sizeof(int*)) / sizeof (int); //uno mas porque llevo sector en el header
const unsigned MAX_FILE_SIZE =NUM_DIRECT*SECTOR_SIZE ;

struct RawFileHeader {
    unsigned index; ///< Tipo de la cabezera, -1 base , 0 y 1 indirecciones, 2 datos con las indirecciones
    unsigned next; 
