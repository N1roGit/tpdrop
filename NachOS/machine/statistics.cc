...
Statistics::Print()
{
    ...
    unsigned long TrueSuccs = numPageSuccs - numPageFaults ;
    printf("Paging: faults %lu , Success %lu HitRatio:%f % \n", numPageFaults,TrueSuccs, ((float)TrueSuccs/(float)numPageSuccs)*100 );
