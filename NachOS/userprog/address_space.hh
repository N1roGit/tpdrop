...
public:
    ...
    TranslationEntry* getTable();
    void LoadPage(unsigned virtualPageNumber,int victim);
    int FindVictim();
    void RemovePage(unsigned physicalPage);
    void SwapPage(int physicalPage, int virtualPage);
    void Update(unsigned virtualAddress);
    void LRU_Update(int i);
    void SaveTLB(unsigned i);
